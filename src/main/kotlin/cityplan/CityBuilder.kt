...
class CityBuilder {
    ...
    private lateinit var cityPlan: CityPlan
    private var residentialBuildings: List<ResidentialBuilding> = ArrayList()
    private var utilityBuildings: List<UtilityBuilding> = ArrayList()
    ...
    companion object {
        private const val RESOURCE_ROOT = "src/main/resources/cityplan"
    }
}
